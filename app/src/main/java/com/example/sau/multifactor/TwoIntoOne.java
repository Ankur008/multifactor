 ...
 */
public class TwoIntoOne extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.two_into_one);

        mobilie_id = android.os.Build.SERIAL;

        linearLayouts[0] = (LinearLayout) findViewById(R.id.linearlayout_1);
        linearLayouts[1] = (LinearLayout) findViewById(R.id.linearlayout_2);
        linearLayouts[2] = (LinearLayout) findViewById(R.id.linearlayout_3);
        ...
        linearLayouts[2].setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (BaseActivity.tap_iteration==2) {
                    ...
                    startActivity(new Intent(BaseActivity.context, TwoIntoOne.class));
