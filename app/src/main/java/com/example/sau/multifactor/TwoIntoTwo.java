 ...
 */
public class TwoIntoTwo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.two_into_two);
        ...
        linearLayouts[2] = (LinearLayout) findViewById(R.id.linearlayout_2_1);
        linearLayouts[3] = (LinearLayout) findViewById(R.id.linearlayout_2_2);
        linearLayouts[4] = (LinearLayout) findViewById(R.id.linearlayout_3);
        ...
        linearLayouts[4].setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (BaseActivity.tap_iteration==2) {
                    ...
                    startActivity(new Intent(BaseActivity.context, TwoIntoTwo.class));
